...
本文定义官方 Codex 扩展、Codex CLI/app-server、Bridge Controller、Remote Executor、
...
| Codex CLI/app-server | 协议重新生成和差异审查、协议兼容测试、`initialize`、`thread/list`、`thread/start`、`thread/resume`、动态工具、MCP 配置覆盖 | `protocol/<version>/`、测试输出、Shim 冒烟输出 |
